...
from api.client.samples.similar_regions.transform import (
    _fill_in_blank_days,
    FourierCoef,
)
...
class TransformTests(unittest.TestCase):
    ...
    def test_fill_in_days(self):
        ...
        fake_pulled_dataset = [
            {u"value": 1, u"start_date": u"2018-09-23T00:00:00.000Z"},
        ...
        np.testing.assert_equal(
            _fill_in_blank_days(10, start_datetime, fake_pulled_dataset),
            np.array(
                [
                    3.0,
                    4.0,
